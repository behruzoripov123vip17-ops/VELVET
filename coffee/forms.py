...
class ReservationForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(attrs={"class": "form-control p-4", "placeholder": "Name", "readonly": True}),
            "email": forms.EmailInput(attrs={"class": "form-control p-4", "placeholder": "Email", "readonly": True}),
